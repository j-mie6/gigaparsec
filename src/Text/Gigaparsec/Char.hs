...
__/Note/:__ The error messages generated by `string` do not reflect how far into the input it managed
...
__/Note/:__ the scope of any backtracking performed is isolated to the key itself, as it is assumed
